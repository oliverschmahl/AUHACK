var r, e, t, a = r => e => {
    ...
    F = (r, e) => {
        var t = m(r, $.i),
            ...
            i = k(n, e),
            f = w(n, i),
            h = (f = g(f, $.l), f = u(f, $.Q), f = v(f), t = s(u(t, f), X), (r => {
                var e = $.c,
                    t = $.u;
                return o(u(m(r, e), t))
            })(i)),
    ...
    U = r => {
        var [e, t] = ((r, e) => {
            ...
            return t
        })(r, [120, 1]), a = o(t)[0], i = R() < a ? 1 : 0, [f, c, p, w] = ((r, e) => {
            var t = [],
                a = 0;
            for (let v = 0; v < K(e); v++) {
                var l = a;
        ...
        var g = 0.15,
            c = h(n(c), N(g)),
            f = (f = l(d(f)), s(f, 1 + g));
        for (let r = 0; r < K(f); r++) f[r] < Q(.02) && (f[r] = f[r] - 100);
        var b = (r => {
            var e = -1e6,
                t = 0;
            for (let o = 0; o < K(r); o++) {
    ...
    E = () => {
        ...
        if (r = 0, e = !1, "-" == "-") var a = K($.g) / 64,
        // if (r = 0, e = !1, "-" == or.value) var a = K($.g) / 64,
            l = W(a * R());
        ...
        var h = ((r, e) => {
            ...
            g = (r, e) => {
                ...
                for (let i = 0; i < t; i++) {
                    var a = e[K(e) - 1],
                        [l, o, r] = L(a, r);
                    if ((d += 1) > 40 * n || o > .5) return void S(w);
    ...
    q = (r, e, t) => {
        ...
        F.setAttribute("d", k), F.style.stroke = "blue", F.style.fill = "blue", lr.appendChild(F)
        F = document.createElementNS("http://www.w3.org/2000/svg", "path");
        F.setAttribute("d", "M 50,250 h650"), F.style.stroke = "black", F.style.fill = "none", F.style["stroke-width"] = "3", lr.appendChild(F)
    },
    B = r => {
        var e = [];
        for (let o = 0; o < K(r); o++) {
            if (0 == o) var t = r[o + 1][0] - r[o][0],
                a = r[o + 1][1] - r[o][1];
    ...
    S = a => {
        if (0 != K(a)) {
            ...
            for (let n = r; n < K(o); n++) {
                a = o[n];
                K(a) < 2 ? 0 != K(a) && 1 != a[0][2] || (r += 1) : (e && lr.removeChild(lr.lastChild), q(a, t, l), 1 == a[K(a) - 1][2] ? (e = !1, r += 1) : e = !0)
            }
        }
    },
...
//     }
// })(tr);
    ur, fr, sr = r => r.toFixed(2),
    hr = r => r.toFixed(3);
ur = "https://d33au9p5d8tjhf.cloudfront.net/d.bin", fr = (() => {
    var r = 0,
        e = [" ", ".", "..", "..", "..."],
    ...
    $ = (r => {
        var e = 0,
            ...
            l = r => {
                ...
                e < a.byteLength ? window.requestAnimationFrame(l) : (setTimeout(async () => E(), 500)/*document.querySelector("#sign").addEventListener("click", async () => {E()})*//*ar("draw-button").addEventListener("mousedown", E)*//*, ar("text-input").addEventListener("keydown", r => 13 === r.keyCode ? E() : 1)*//*, ar("loading-indicator").remove()*/)
            };
        return l(), t
    })(r), clearTimeout(fr)
});
